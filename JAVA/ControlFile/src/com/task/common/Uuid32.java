    ...
    implements Serializable
{
    ...
    public static synchronized Uuid32 create()
    ...
    private Uuid32(long high, long low)
    {
        str36 = null;
        this.high = high;
        this.low = low;
    ...
    {
        if(obj != null && (obj instanceof Uuid32))
            return high == ((Uuid32)obj).high && low == ((Uuid32)obj).low;
        else
            return false;
    }
    ...
    public static Uuid32 read(DataInput in)
        throws IOException
    {
        long high = in.readLong();
        long low = in.readLong();
        return new Uuid32(high, low);
    }

    public static Uuid32 read(String id)
        throws UuidException
    {
        ...
        Uuid32 uuid = new Uuid32(high, low);
        return uuid;
    }
    ...
    public static void main(String args[])
    {
        try
        {
            ...
            {
            	Uuid32 uuid = create();
                System.out.println("aaaaa-----"+uuid.toString().length());
           }
