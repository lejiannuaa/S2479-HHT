 ...
 * 
 */
public class HHT_005_03 extends BusinessService implements ProcessUnit {
	...
	public String process(Request request) {
		...
		try {
			...
			String file = printTemplate2.createReport(bean.getUser().getOwnerFilePath(), bean.getUser().getStore(),
					new String[] { bc }, bc);
		...
		log.info("operation hht005.03打印PO收货单, response="+bean.getResponse().toString());
