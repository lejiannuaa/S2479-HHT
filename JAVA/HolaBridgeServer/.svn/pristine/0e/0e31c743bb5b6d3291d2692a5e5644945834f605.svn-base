...
public class HHT_1045_03 extends BusinessService implements ProcessUnit{
	...
	public String process(Request request) {
		...
		log.info("店店调拨查询, response="+bean.getResponse().toString());
	...
	private void processData(BusinessBean bean) throws Exception {
        ...
        String sql = sqlpropertyUtil.getValue(store, "hht1045.03.01");
