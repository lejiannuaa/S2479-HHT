...
public class HHT_1046_05 extends BusinessService implements ProcessUnit {
	...
	public String process(Request request) {
		...
		try {
			...
			String[] fileMettle = printTemplate9.createReportList(
					bean.getUser().getOwnerFilePath(), 
					store,
					new String[]{store,today,bean.getUser().getName(),startTime});
