 ...
 * 请求复盘单号的相关柜号信息
 * @author S2139
 * 2012 Aug 24, 2012 4:10:55 PM 
 */
public class HHT_600_02 extends BusinessService implements ProcessUnit {
	...
	public String process(Request request) {
		...
		log.info("请求复盘单号的相关柜号信息, response="+bean.getResponse().toString());
	...
	private void processData(BusinessBean bean) throws Exception{
		...
		String sql = sqlpropertyUtil.getValue(store, "hht600.01.02");
		Object[] o = new Object[]{stk_no,userId,stk_type};
