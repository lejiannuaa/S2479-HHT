...
var PageName = '出货查询';
var PageId = 'eb5989a4ca984faa9f686c60b1882570'
var PageUrl = '出货查询.html'
document.title = '出货查询';
var PageNotes = 
{
"pageName":"出货查询",
...
if (true) {
	...
	self.location.href="出货明细.html" + GetQuerystring();
...
if (true) {
	...
	self.location.href="查询_报表.html" + GetQuerystring();
