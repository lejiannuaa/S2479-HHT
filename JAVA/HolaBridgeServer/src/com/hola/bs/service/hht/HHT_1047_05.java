...
public class HHT_1047_05 extends BusinessService implements ProcessUnit{
	...
	public String process(Request request) {
		...
		log.info("库存调整查询-查询, response="+bean.getResponse().toString());
	...
	private void processData(BusinessBean bean) throws Exception {
        ...
        String sql = sqlpropertyUtil.getValue(store, "hht1047.05.01");
