...
public class HHT_1046_04 extends BusinessService implements ProcessUnit{
	public String process(Request request) {
		...
		log.info("下单申请新增-明细, response="+bean.getResponse().toString());
	...
	private void processData(BusinessBean bean) throws Exception {
        ...
        String sql = sqlpropertyUtil.getValue(store, "hht1046.04.01");
