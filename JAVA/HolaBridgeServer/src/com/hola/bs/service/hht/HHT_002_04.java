 ...
 *
 */
public class HHT_002_04 extends BusinessService implements ProcessUnit {
	
	@Autowired(required = true)
	private PrintTemplate3 printTemplate3;
//	private PrintTemplate4 printTemplate3;
	...
	public String process(Request request){
		...
		try {
			...
			String file = printTemplate3.createReport(bean.getUser().getOwnerFilePath(), bean.getUser().getStore(),new String[]{bc}, bc);
		...
		log.info("operation hht002.04, response="+bean.getResponse().toString());
