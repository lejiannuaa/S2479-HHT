...
public class DateUtil {
 ...
 ////////////----------------------
	...
	public static String getAddDate(String date,int i,int type){
		...
		return DateUtil.formatshort(cl.getTime());
	}
...
//
// 		String s1="2008-01-20 09:12:11";
//        String s2="2008-01-29 09:12:11";
//        DateUtil.compareDate(s1, s2);
//        
//        
//        int week = 6/7;
//        int weekFew = 6 %7;
...
//        System.out.println(weekFew);
//    	System.out.println(" 1 = "+Integer.parseInt(DateUtil.getNowDate().split("-")[1]));
//    	System.out.println(DateUtil.getNowDate().substring(5,DateUtil.getNowDate().length()));
//    	Calendar c = Calendar.getInstance();
//    	c.setTime(DateUtil.parse2("2009-05-1"));
//    	System.out.println("天数�?=" + c.getActualMaximum(Calendar.DAY_OF_MONTH)); 
//    	String a = "2009-04-11 01:02:03";
//    	String a = "XX00460-2008-9-A(XX00460)";
//    	String b = "abcde,";
//    	String[] s = DateUtil.getAllYear("2007-09-01", "2011-01-01");
//    	for(int i=0;i<s.length;i++){
//    		System.out.println(s[i]);
//    	}
//    	System.out.println(DateUtil.getPreMonth26("2009-04-30 00:00:00"));
//    	System.out.println(DateUtil.getThisMonth25("2009-04-30 00:00:00"));
//    	DateUtil.getAllYear("2009-01-01", "2011-01-01");
    	try {
//			URL u = new URL("file:///D://a.xls");//output.xls  3d0077af0000010a.doc
//			String fileName = "output.doc";
//			String fileType=null;
//
//		      if(fileName.endsWith(".xls"))  fileType="T";
//		      if(fileName.endsWith(".doc"))fileType="H";
//		      System.out.println(fileType);
//    		 System.out.println(DateUtil.getAddDate("2009-06-20", 3, 1));
//    		String s = "R012";
//    		System.out.println(DateUtil.getLast10Str());
//    		String a ="00";
//    		String b = "00";
//    		System.out.println(b.compareTo(a));
//    		System.out.println(DateUtil.getAddDate(DateUtil.getNowDate(), 1, 1));
